// Composes Agent memory runtime services and local memory adapters.
...
export interface ComposeAgentMemoryOptions {
...
export function composeAgentMemory(options: ComposeAgentMemoryOptions) {
...
export type MemoryRuntimeComposition = ReturnType<typeof composeAgentMemory>;
