// Agent memory runtime capture orchestrates long-term memory capture after completed runs.
...
export interface MemoryRuntimeCaptureAttempt {
...
export interface MemoryRuntimeCaptureOptions {
  ...
  markdownSync: MemoryMarkdownExportPort;
  diagnostics: MemoryDiagnosticWriterPort;
