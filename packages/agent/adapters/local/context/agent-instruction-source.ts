// Agent instruction source service discovers and loads agent instruction files through host ports.
// The service performs discovery only; context priority and budget stay in @megumi/agent/context.
