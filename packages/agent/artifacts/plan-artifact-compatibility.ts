...
// Agent plan artifact compatibility service bridges implementation-plan records into the artifact system.
// Repository port is supplied by the host.

export interface PlanArtifactCompatibilityRepositoryPort {
  getArtifact(artifactId: string): Artifact | undefined;
  saveArtifact(artifact: Artifact): Artifact;
}

export interface PlanArtifactCompatibilityServiceOptions {
  repository: PlanArtifactCompatibilityRepositoryPort;
}
