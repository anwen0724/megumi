...
export function toHostFailure(failure: { code?: string; message: string; retryable?: boolean }): HostFailure {
  return {
...
export function fromPermissionRuleUi(rule: PermissionRuleUiDto): PermissionRule {
  return {
