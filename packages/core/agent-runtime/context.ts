...
export function isContextPatchObservation(observation: AgentObservation): boolean {
  return observation.kind === 'context_patch_applied' || observation.kind === 'context_patch_rejected';
}

export function toContextPatchAppliedPayload(observation: AgentObservation): ContextPatchAppliedPayload | undefined {
...
export function toContextPatchRejectedPayload(observation: AgentObservation): ContextPatchRejectedPayload | undefined {
