...
import type { AgentObservation } from '@megumi/shared/agent-lifecycle-contracts';
...
export function createCheckpointObservation(input: CreateCheckpointObservationInput): AgentObservation {
  return {
...
export function createResumeObservation(input: CreateResumeObservationInput): AgentObservation {
  return {
    observationId: input.observationId,
    runId: input.runId,
    stepId: input.stepId,
...
export function createCancelObservation(input: CreateCancelObservationInput): AgentObservation {
  return {
    observationId: input.observationId,
    runId: input.runId,
    stepId: input.stepId,
...
export function createRetryObservation(input: CreateRetryObservationInput): AgentObservation {
  return {
    observationId: input.observationId,
    runId: input.runId,
    stepId: input.stepId,
...
export function isRecoveryObservation(observation: AgentObservation): boolean {
