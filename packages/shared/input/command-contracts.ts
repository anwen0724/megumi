// Defines input command contracts shared by renderer payload builders and trusted runtime validators.
import { z } from 'zod';
...
export const INPUT_PROMPT_SOURCES = ['fallback', 'prompt_template', 'skill', 'input_hook_transform'] as const;
