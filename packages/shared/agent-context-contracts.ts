...
export const AgentContextSchema = z
  .object({
    ...
    resourceRefs: z.array(ContextSourceRefSchema),
    conversationRefs: z.array(IdSchema),
    messageSummaries: z.array(z.string()),
    workspaceSources: z.array(ContextSourceRefSchema),
...
export interface AgentContext {
  contextId: AgentContextId | string;
  runId: RunId | string;
  stepId?: AgentStepId | string;
  baselineContextId?: AgentContextId | string;
  workspaceBoundary: WorkspaceBoundary;
  goal: string;
  constraints: string[];
  inlineContents: ContextInlineContent[];
  resourceRefs: ContextSourceRef[];
  conversationRefs: string[];
  messageSummaries: string[];
  workspaceSources: ContextSourceRef[];
  toolObservationRefs: Array<AgentObservationId | string>;
...
export const EffectiveContextBuildSchema = z
  .object({
    buildId: IdSchema,
    contextId: IdSchema,
    runId: IdSchema,
...
export interface EffectiveContextBuild {
  buildId: EffectiveContextBuildId | string;
  contextId: AgentContextId | string;
  runId: RunId | string;
  stepId?: AgentStepId | string;
...
export interface ContextPatchAppliedPayload {
  patchId: ContextPatchId | string;
  operation: ContextPatchOperation;
  effectiveContextBuildId?: EffectiveContextBuildId | string;
}
