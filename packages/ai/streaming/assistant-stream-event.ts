...
export type AssistantContentBlockDelta = z.infer<
    typeof AssistantContentBlockDeltaSchema
>;
...
export type AssistantContentBlockStart = z.infer<
    typeof AssistantContentBlockStartSchema
>;
...
export const AssistantStreamEventSchema = z.discriminatedUnion('type', [
    ...
    z
        .object({
            ...
            block: AssistantContentBlockStartSchema,
        })
        .strict(),
    ...
    z
        .object({
            ...
            index: z.number().int().nonnegative(),
            delta: AssistantContentBlockDeltaSchema,
        })
        .strict(),

    z
        .object({
            type: z.literal('content_block_end'),
            index: z.number().int().nonnegative(),
            block: AssistantContentBlockSchema,
        })
        .strict(),
...
export type AssistantStreamEvent =
    ...
    index: number;
    block: AssistantContentBlockStart;
}
    | {
    type: 'content_block_delta';
    index: number;
    delta: AssistantContentBlockDelta;
}
    | {
