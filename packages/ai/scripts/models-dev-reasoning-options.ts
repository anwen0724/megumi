...
/**
 * Converts models.dev verified effort values into Megumi's selectable thinking levels.
 * Values without a Megumi equivalent (`default` and JSON `null`) are intentionally
 * omitted.
 */
