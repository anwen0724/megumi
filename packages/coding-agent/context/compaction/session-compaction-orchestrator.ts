...
export interface SessionCompactionOrchestratorModelStepProvider {
  completeModelCall(request: ModelStepRuntimeRequest): Promise<SessionCompactionModelCallResult>;
}

export type SessionCompactionModelCallResult =
  | {
      ok: true;
      text: string;
      toolCalls?: SessionCompactionModelCallToolCall[];
...
export interface SessionCompactionModelCallToolCall {
