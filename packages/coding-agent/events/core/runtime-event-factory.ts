...
export function createCheckpointCreatedEvent(
  input: Omit<
    Parameters<typeof createRuntimeCheckpointCreatedEvent>[0],
    'source'
  >,
  payload: Parameters<typeof createRuntimeCheckpointCreatedEvent>[1],
): ReturnType<typeof createRuntimeCheckpointCreatedEvent> {
  return createRuntimeCheckpointCreatedEvent({ ...input, source: 'core' }, payload);
}

export function createRunResumeRequestedEvent(
  input: Omit<
    Parameters<typeof createRuntimeRunResumeRequestedEvent>[0],
    'source'
  >,
  payload: Parameters<typeof createRuntimeRunResumeRequestedEvent>[1],
): ReturnType<typeof createRuntimeRunResumeRequestedEvent> {
  return createRuntimeRunResumeRequestedEvent({ ...input, source: 'core' }, payload);
}

export function createRunCancelRequestedEvent(
  input: Omit<
    Parameters<typeof createRuntimeRunCancelRequestedEvent>[0],
    'source'
  >,
  payload: Parameters<typeof createRuntimeRunCancelRequestedEvent>[1],
): ReturnType<typeof createRuntimeRunCancelRequestedEvent> {
  return createRuntimeRunCancelRequestedEvent({ ...input, source: 'core' }, payload);
}

export function createRunRetryRequestedEvent(
  input: Omit<
    Parameters<typeof createRuntimeRunRetryRequestedEvent>[0],
    'source'
  >,
  payload: Parameters<typeof createRuntimeRunRetryRequestedEvent>[1],
): ReturnType<typeof createRuntimeRunRetryRequestedEvent> {
