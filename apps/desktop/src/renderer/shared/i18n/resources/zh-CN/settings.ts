...
export const settings = {
  ...
  categories: {
    ...
    skills: { label: 'Skills', description: '查看和管理 Megumi 可用于任务的工作流程。' },
  ...
  skills: {
    ...
    deleteDescription: '这会永久删除整个 Skill 包，包括其中的资源、脚本和素材。',
    cancelDelete: '取消', confirmDelete: '删除 Skill', deleting: '正在删除…',
    deleteNotAllowed: '这个 Skill 不能由 Megumi 删除。',
