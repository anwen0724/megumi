...
export const settings = {
  ...
  diagnostics: {
    ...
    rebuilt: 'Trace 索引已重建。', rebuildIndex: '重建索引', traceKind: 'Trace 类型', allKinds: '全部类型', statusLabel: '状态', allStatuses: '全部状态', correlation: '关联标识', correlationPlaceholder: 'execution:… / batch:…', startedAfter: '开始时间不早于', startedBefore: '开始时间早于', recentTraces: '最近 Trace', traceCount: '保留 {{count}} 条', selectTrace: '选择一条 Trace', spanFilter: 'Span 名称', allSpans: '全部 Span 名称', contentFilter: 'Content 类型', allContent: '全部 Content 类型', spanTree: 'Span 耗时', noSpans: '没有记录 Span。', sequenceTimeline: 'Event 与 Content 顺序', noTimeline: '没有记录 Event 或 Content 检查点。', viewContent: '查看内容', loadingContent: '正在读取…', binaryContent: '二进制内容只显示元数据', contentUnavailable: '内容不可用。', checksum: 'SHA-256', byteUnit: 'B', traceLinks: 'Trace 关联', issues: '诊断问题', healthSummary: '丢弃 {{dropped}} 条 · 失败 {{failures}} 次', legacy: '旧版诊断', legacyDescription: '旧格式诊断保持只读，无法查看 Content。', legacyRecordSummary: '{{status}} · {{count}} 条记录 · 无内容', noLegacy: '没有保留的旧版诊断。',
    empty: '暂无活动记录。', selectHint: '选择最近的 Trace，以检查耗时和捕获的检查点。', export: '导出诊断',
    traceKinds: { conversation: '对话', dailyDiscovery: '每日发现' },
    traceCounts: '{{spans}} 个 Span · {{content}} 个 Content · {{issues}} 个问题', spanCount: '{{count}} 个 Span', eventCount: '{{count}} 个 Event', contentCount: '{{count}} 个 Content', eventSequence: '#{{sequence}} · Event',
