...
export const settings = {
  ...
  categories: {
    ...
    voice: { label: 'Voice & Speech', description: 'Manage the voices Megumi can speak with on this device.' },
  ...
  voice: {
    ...
    modelsDescription: 'Download the local resources Megumi needs for voice conversations.',
    ...
    modelsUpdate: 'Update',
    modelsReady: 'Ready',
    savedTitle: 'Available voices',
    savedDescription: 'Choose the default voice used by the character window.',
    profileBuiltIn: 'Built-in voice',
    profileCustom: 'Custom reference audio',
    profileChineseFemale: 'Chinese female voice',
    profileChineseMale: 'Chinese male voice',
    profileEnglishFemale: 'English female voice',
    profileEnglishMale: 'English male voice',
    preview: 'Preview',
    previewing: 'Generating',
    previewNamed: 'Preview {{name}}',
    previewModelsRequired: 'Download and prepare the voice models before previewing a voice.',
    previewFailed: 'The voice preview could not be generated. Try again.',
    previewPlaybackFailed: 'The preview could not play through the selected output device.',
    componentOutdated: 'The local voice component version does not match. Restart Megumi; rebuild the voice component if it persists.',
    empty: 'No voice profiles are available yet.',
    selected: 'Selected',
    addTitle: 'Add a voice',
    addDescription: 'Name the voice, then choose a short reference audio file from this device.',
    name: 'Voice name',
    namePlaceholder: 'For example, Megumi soft',
    add: 'Add voice',
    adding: 'Choosing audio…',
  },
  skills: {
