...
export const settings = {
  ...
  categories: {
    ...
    voice: { label: 'Voice Input', description: 'Manage the microphone and recognition language Megumi uses on this device.' },
  ...
  voice: {
    ...
    devicesDescription: 'Choose the microphone and recognition language used by voice sessions.',
