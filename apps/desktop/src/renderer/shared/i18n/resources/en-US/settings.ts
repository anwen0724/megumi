...
export const settings = {
  ...
  diagnostics: {
    ...
    rebuilt: 'Trace index rebuilt.', rebuildIndex: 'Rebuild index', traceKind: 'Trace kind', allKinds: 'All kinds', statusLabel: 'Status', allStatuses: 'All statuses', correlation: 'Correlation', correlationPlaceholder: 'execution:… / batch:…', startedAfter: 'Started after', startedBefore: 'Started before', recentTraces: 'Recent Traces', traceCount: '{{count}} retained', selectTrace: 'Select a Trace', spanFilter: 'Span name', allSpans: 'All Span names', contentFilter: 'Content kind', allContent: 'All Content kinds', spanTree: 'Span timing', noSpans: 'No spans recorded.', sequenceTimeline: 'Event & Content sequence', noTimeline: 'No events or Content checkpoints recorded.', viewContent: 'View content', loadingContent: 'Reading…', binaryContent: 'Binary content is shown as metadata only', contentUnavailable: 'Content is unavailable.', checksum: 'SHA-256', byteUnit: 'B', traceLinks: 'Trace links', issues: 'Diagnostic issues', healthSummary: '{{dropped}} dropped · {{failures}} failures', legacy: 'Legacy diagnostics', legacyDescription: 'Old-format diagnostics remain read-only and cannot expose Content.', legacyRecordSummary: '{{status}} · {{count}} records · no content', noLegacy: 'No retained Legacy diagnostics.',
    empty: 'No activity recorded yet.', selectHint: 'Choose a recent Trace to inspect its timing and captured checkpoints.', export: 'Export diagnostics',
    traceKinds: { conversation: 'Conversation', dailyDiscovery: 'Daily discovery' },
    traceCounts: '{{spans}} spans · {{content}} content · {{issues}} issues', spanCount: '{{count}} spans', eventCount: '{{count}} events', contentCount: '{{count}} content', eventSequence: '#{{sequence}} · event',
