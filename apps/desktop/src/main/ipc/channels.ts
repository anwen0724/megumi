...
export const IPC_CHANNELS = {
  ...
  voice: {
    ...
    profileImport: 'voice:profile:import',
    profileRename: 'voice:profile:rename',
    profileRemove: 'voice:profile:remove',
    profileSelect: 'voice:profile:select',
    profilePreview: 'voice:profile:preview',
...
const ALL_IPC_CHANNELS = [
  ...
  IPC_CHANNELS.voice.playbackStop,
  IPC_CHANNELS.voice.playbackResult,
