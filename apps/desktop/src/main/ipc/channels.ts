...
export const IPC_CHANNELS = {
  ...
  applicationUpdate: {
    snapshotGet: 'application-update:snapshot:get',
    check: 'application-update:check',
    automaticChecksSet: 'application-update:automatic-checks:set',
    automaticDownloadsSet: 'application-update:automatic-downloads:set',
    download: 'application-update:download',
    restartAndInstall: 'application-update:restart-and-install',
    releasePageOpen: 'application-update:release-page:open',
    snapshotChanged: 'application-update:snapshot:changed',
  },
  settings: {
    get: 'settings:get',
    ...
    providerGetApiKey: 'provider:get-api-key',
    providerSetApiKey: 'provider:set-api-key',
    providerDeleteApiKey: 'provider:delete-api-key',
    webSearchGetApiKey: 'web-search:get-api-key',
    voiceTtsGetApiKey: 'voice-tts:get-api-key',
    voiceTtsSetApiKey: 'voice-tts:set-api-key',
    voiceTtsDeleteApiKey: 'voice-tts:delete-api-key',
    discoveryCredentialGet: 'settings:discovery-credential:get',
    discoveryCredentialSet: 'settings:discovery-credential:set',
    discoveryCredentialDelete: 'settings:discovery-credential:delete',
  },
  session: {
  ...
  discovery: {
    ...
    sourceRefresh: 'discovery:source:refresh',
    sourcesRefresh: 'discovery:sources:refresh',
    interestChange: 'discovery:interest:change',
    sessionParticipationSet: 'discovery:session-participation:set',
    recommendationRequest: 'discovery:recommendation:request',
  ...
  voice: {
    ...
    speechOutputStop: 'voice:speech-output:stop',
    speechOutputEvent: 'voice:speech-output:event',
...
const ALL_IPC_CHANNELS = [
  ...
  IPC_CHANNELS.applicationUpdate.snapshotGet,
  IPC_CHANNELS.applicationUpdate.check,
  IPC_CHANNELS.applicationUpdate.automaticChecksSet,
  IPC_CHANNELS.applicationUpdate.automaticDownloadsSet,
  IPC_CHANNELS.applicationUpdate.download,
  IPC_CHANNELS.applicationUpdate.restartAndInstall,
  IPC_CHANNELS.applicationUpdate.releasePageOpen,
  ...
  IPC_CHANNELS.voice.speechOutputEvent,
