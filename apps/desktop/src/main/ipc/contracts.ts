...
export const BUSINESS_IPC_CHANNELS = [
  ...
  IPC_CHANNELS.settings.webSearchGetApiKey,
  IPC_CHANNELS.settings.voiceTtsGetApiKey,
  IPC_CHANNELS.settings.voiceTtsSetApiKey,
  IPC_CHANNELS.settings.voiceTtsDeleteApiKey,
