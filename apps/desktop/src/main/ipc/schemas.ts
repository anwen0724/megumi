...
export const BrowserSourceConnectionGetRequestSchema = createRuntimeIpcRequestSchema(IPC_CHANNELS.browserSource.connectionGet, host.BrowserSourceEmptyRequestSchema);
export const BrowserSourcePairingBeginRequestSchema = createRuntimeIpcRequestSchema(IPC_CHANNELS.browserSource.pairingBegin, host.BrowserSourceEmptyRequestSchema);
export const BrowserSourceConnectionRevokeRequestSchema = createRuntimeIpcRequestSchema(IPC_CHANNELS.browserSource.connectionRevoke, host.BrowserSourceEmptyRequestSchema);
