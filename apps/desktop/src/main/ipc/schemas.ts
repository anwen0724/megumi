...
export const AttachmentFileStatusRequestSchema = createRuntimeIpcRequestSchema(IPC_CHANNELS.chat.attachmentFileStatus, host.AttachmentFileStatusPayloadSchema);
