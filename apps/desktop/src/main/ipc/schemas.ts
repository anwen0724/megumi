...
export const SessionListRequestSchema = createRuntimeIpcRequestSchema(IPC_CHANNELS.chat.sessionList, host.EmptyHostPayloadSchema);
...
export const SettingsGetRequestSchema = createRuntimeIpcRequestSchema(IPC_CHANNELS.settings.get, host.EmptyHostPayloadSchema);
...
export const ProviderListRequestSchema = createRuntimeIpcRequestSchema(IPC_CHANNELS.settings.providerList, host.EmptyHostPayloadSchema);
...
export const ProjectListRequestSchema = createRuntimeIpcRequestSchema(IPC_CHANNELS.workspace.projectList, host.EmptyHostPayloadSchema);
export const ProjectUseExistingRequestSchema = createRuntimeIpcRequestSchema(IPC_CHANNELS.workspace.projectUseExisting, host.EmptyHostPayloadSchema);
