...
export const ProviderGetApiKeyRequestSchema = createRuntimeIpcRequestSchema(IPC_CHANNELS.settings.providerGetApiKey, host.ProviderDeleteApiKeyPayloadSchema);
...
export const WebSearchGetApiKeyRequestSchema = createRuntimeIpcRequestSchema(IPC_CHANNELS.settings.webSearchGetApiKey, host.SettingsGetPayloadSchema);
export const VoiceTtsGetApiKeyRequestSchema = createRuntimeIpcRequestSchema(IPC_CHANNELS.settings.voiceTtsGetApiKey, host.SettingsGetPayloadSchema);
...
export type ProviderGetApiKeyPayload = z.infer<typeof host.ProviderDeleteApiKeyPayloadSchema>;
