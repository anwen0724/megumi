...
export interface AgentArtifactServiceIds {
  artifactId(): string;
...
export interface AgentArtifactServiceOptions {
  repository: Pick<
    ArtifactRepository,
    | 'saveArtifact'
    | 'getArtifact'
  ...
  ids?: AgentArtifactServiceIds;
}

const defaultIds: AgentArtifactServiceIds = {
...
export class AgentArtifactService {
  private readonly ids: AgentArtifactServiceIds;

  constructor(private readonly options: AgentArtifactServiceOptions) {
