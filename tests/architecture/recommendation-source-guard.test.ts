/* Prevents Recommendation from regaining Source, Search, or Candidate Supply execution dependencies. */
// @vitest-environment node
import { readFileSync, readdirSync, statSync } from 'node:fs';
import path from 'node:path';
import { describe, expect, it } from 'vitest';

const root = path.resolve(process.cwd(), 'packages/agent/discovery/src/recommendation');

describe('Recommendation source boundary', () => {
