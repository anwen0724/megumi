...
import { PlanArtifactCompatibilityService, type PlanArtifactCompatibilityRepositoryPort } from '@megumi/agent/artifacts';
import type { ImplementationPlanArtifactRecord } from '@megumi/agent/artifacts/legacy-contracts/plan-artifact-contracts';
