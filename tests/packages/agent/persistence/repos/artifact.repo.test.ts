...
import { ArtifactRepository } from '@megumi/agent/persistence/repos/artifact.repo';
...
import type { Artifact, ArtifactVersion } from '@megumi/agent/artifacts/legacy-contracts/artifact-contracts';
