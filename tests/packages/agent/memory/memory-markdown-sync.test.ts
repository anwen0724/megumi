...
import { MemoryDiagnosticWriter } from '@megumi/agent/adapters/local/memory/memory-diagnostic-writer.service';
import { MemoryMarkdownSyncService } from '@megumi/agent/adapters/local/memory/memory-markdown-sync.service';
import type { MemoryMarkdownSyncCaptureAttempt } from '@megumi/agent/adapters/local/memory/memory-markdown-sync.service';
import type { MemoryRuntimeFileSystem } from '@megumi/agent/adapters/local/memory/memory-runtime-file-system';
import { resolveProjectMemoryMirrorTarget } from '@megumi/agent/adapters/local/memory/memory-runtime-paths';
import type {
  MemoryAuditLog,
