...
} from '@megumi/agent/context/service/internal/compaction-summary-builder';

const EXPECTED_PROMPT = `You are updating the rolling context summary for an ongoing agent session.
