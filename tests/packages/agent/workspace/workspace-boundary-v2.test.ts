...
const workspaceRoot = join(repoRoot, 'packages/agent/workspace');
...
describe('workspace module boundary v2', () => {
  ...
  it('keeps Workspace free of shared project/workspace contracts and legacy persistence repos', () => {
    const files = [
      'packages/agent/workspace/contracts/workspace-contracts.ts',
      'packages/agent/workspace/contracts/workspace-change-contracts.ts',
      'packages/agent/workspace/services/workspace-service.ts',
      'packages/agent/workspace/services/workspace-path-policy-service.ts',
      'packages/agent/workspace/services/workspace-change-service.ts',
      ...
      'packages/agent/workspace/core/workspace-path-policy.ts',
      'packages/agent/workspace/core/workspace-change-tracking.ts',
    ];
