...
import { BrowserSourceConnectionViewSchema, BrowserSourcePairingViewSchema } from '@megumi/product/host';
import { createBrowserSourceOperations } from '../../../../packages/product/src/operations/browser-source-operations';
