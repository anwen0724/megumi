    ...
    const context = buildModelInputContext({
      ...
      parts: [
        ...
        basePart({
          ...
          sourceRefs: [sourceRef('tool-use:1', 'tool_call')],
          priority: 80,
    ...
    const context = buildModelInputContext({
      ...
      parts: [
        basePart({
          ...
          sourceRefs: [sourceRef('tool-use:missing-result-content', 'tool_call')],
          toolCallId: 'tool-use:missing-result-content',
    ...
    const context = buildModelInputContext({
      ...
      parts: [
        basePart({
          ...
          sourceRefs: [sourceRef('tool-use:local-tool-use-1', 'tool_call')],
    ...
    const context = buildModelInputContext({
      ...
      parts: [
        basePart({
          ...
          sourceRefs: [sourceRef('tool-use:matched-provider-state', 'tool_call')],
    ...
    const context = buildModelInputContext({
      ...
      parts: [
        basePart({
          ...
          sourceRefs: [sourceRef('tool-use:matched', 'tool_call')],
