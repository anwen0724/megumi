...
function assistant(items: ReturnType<typeof tool>[]): TimelineMessage {
  return {
    messageId: 'assistant-1', role: 'assistant', projectId: 'workspace-1', sessionId: 'session-1', executionId: 'run-1',
    createdAt: '2026-07-20T00:00:00.000Z',
    blocks: [{ blockId: 'process:run-1', kind: 'process_disclosure', executionId: 'run-1', status: 'running', items }],
  };
}
